...
#	gpio.setup(config['raspberrypi']['button'], gpio.IN, pull_up_down=gpio.PUD_UP)
	gpio.setcfg(config['raspberrypi']['button'], gpio.INPUT)
	gpio.pullup(config['raspberrypi']['button'], gpio.PULLUP)
#	gpio.setup(config['raspberrypi']['lights'], gpio.OUT)
	gpio.setup(config['raspberrypi']['lights[0]'], gpio.OUTPUT)
	gpio.setup(config['raspberrypi']['lights[1]'], gpio.OUTPUT)
#	gpio.output(config['raspberrypi']['lights'], gpio.LOW)
	gpio.output(config['raspberrypi']['lights[0]'], gpio.LOW)
	gpio.output(config['raspberrypi']['lights[1]'], gpio.LOW)
